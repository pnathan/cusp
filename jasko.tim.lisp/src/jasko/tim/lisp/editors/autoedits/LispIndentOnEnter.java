...
public class LispIndentOnEnter implements IAutoEditStrategy {
   ...
   public static String calculateIndent(int offset, IDocument doc) {
      ...
      LispUtil.FunctionInfo prevFunc = LispUtil.getCurrentFunctionInfo(doc,
                                                                       fi.offset);
      LispUtil.FunctionInfo prev2Func = LispUtil.getCurrentFunctionInfo(doc,
                                                                        prevFunc.offset);
      ...
      try {
         ...
         // System.out.println("*prev2: " + prev2Func.name + "," +
         // LispUtil.getParameterNumber(doc, offset, prev2Func));
         // System.out.println("*prev: " + prevFunc.name + "," +
         // LispUtil.getParameterNumber(doc, offset, prevFunc));
         // System.out.println("*fi: " + fi.name + "," +
         // LispUtil.getParameterNumber(doc, offset, fi));
         if (swank.specialIndents.containsKey(fi.name)) {
            ...
            if (swank.fletIndents.containsKey(prev2Func.name) &&
               ...
               if (swank.indents.containsKey(fi.name)) {
                  ...
                  if (swank.handlerCaseIndents.containsKey(prevFunc.name) &&
